...
%          NaN.
% 23062008 MK: if function values at endpoint are inf or NaN, MKFZERO no
%          longer throws an error but terminates regularly and returns NaN.
