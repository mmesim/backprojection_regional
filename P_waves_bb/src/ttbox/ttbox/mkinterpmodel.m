...
%                   16.06.2006, 28.08.2007, 28.10.2011
%
...
% 28102011: do not attempt to interpolate if there are less than 2 points
%           in the segment!
...
%%% check if the model is error free MK28082007
mkchkmodelintegrity(model);
...
%     drawnow;
    ...
    %%% interpolation is also not carried out if modrange contains only one
    %%% point, because that is not possible. MK28102011
    if numel(modrange)>1
