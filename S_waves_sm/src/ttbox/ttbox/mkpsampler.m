...
% function.
%
% Martin Knapmeyer, 23.06.2006, 16.12.2009

% 13122006 pscan entries with dist==inf are also removed
% 16122009 problem if mksmarttakeoff returns empty resolved
...
if isempty(anglerange)
   %%% MKSMARTTAKEOFF will return empty in some cases.
   %%% In that case, do not proceed! MK16122009
   return; % jump out!
end; % if isempty(anglerange)
