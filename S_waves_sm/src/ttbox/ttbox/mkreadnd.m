...
%
% If the routine is called without input arguments, an empty MODEL
% structure is returned. MKREADND is thus usable as constructor for this
% type of structure.
%
...
%                   25.04.2006, 28.08.2007, 21.04.2011
%
...
% apply mkchkmodelintegrity MK28082007
...
%%% now check the completed model for overall integrity
